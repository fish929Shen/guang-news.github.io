(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_6883bf205ec92f3275050e5c")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '67bad56a277e1602640a05cd';
_mrmcp['creative_id'] = '6883bf205ec92f3275050e5c';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '数据新闻啊';
_mrmcp['build_number'] = parseInt('460');
_mrmcp['publish_time'] = 'Wed Jul 30 2025 05:12:25 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://6883bf205ec92f3275050e5c.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.4.60';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1753823545522", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1753823545522" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
